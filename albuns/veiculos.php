...
<body>
	...
	<div class="album"> 
		...
		<div class='row'>
			...
			$resultado = $pdo->query("SELECT * FROM veiculos ORDER BY id DESC");
			$mostrar = $resultado->fetchAll(PDO::FETCH_ASSOC);
			for ($i = 0; $i < count($mostrar); $i++) {

				echo "  <div class='galeria'> <a href='../bd/imagens/veiculos/" . $mostrar[$i]['imagem'] . "'>   <img  src='../bd/imagens/veiculos/" . $mostrar[$i]['imagem'] . "' >  </a></div> ";
			}
